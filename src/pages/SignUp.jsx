  ...
  return (
    <div className="bg-gradient-to-r from-cyan-300 to-blue-400 grid grid-cols-1 sm:grid-cols-2 h-screen w-full relative">
      ...
      >
        ...
        <Link
          to='/'
          className="absolute top-0 left-0 m-6 py-2 px-4 rounded-lg bg-blue-500 text-white font-bold hover:bg-blue-700 focus:outline-none focus:shadow-outline cursor-pointer" 
        >
          <motion.div
