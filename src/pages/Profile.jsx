...
import {FaUserAlt, FaGraduationCap, FaUserFriends, FaMedal} from 'react-icons/fa'
const Profile = () => {
    const handleGoBack = () => {
  ...
  return (
    <section className='section flex flex-col items-center justify-center h-screen overflow-y-scroll'>
      <motion.button 
      ...
      className="bg-white rounded-lg shadow-md w-5/6  mt-[1330px]">
        <div className="h-32">
          <img
  ...
  <hr class="border-gray-300 my-1 mt-16"/>
    ...
    <div class="flex flex-row text-center">
            <div class="w-1/2">
                ...
                <p className=''>Politeknik Negeri Batam</p>
            </div>
            <div class="w-1/2">
            ...
            <div class="w-1/2">
                ...
                <p>D4 Teknologi Rekayasa Perangkat Lunak</p>
            </div>
            <div class="w-1/2">
            ...
            <div class="w-1/2">
                <p class="font-medium ml-7 text-blue-500">Action</p>
                <div className="absolute top-32 right-0 flex justify-end">
        <button className="text-medium bg-blue-500 px-4 rounded-full text-white hover:text-gray-800 mr-2 mb-12">Edit</button>
        <button className="text-medium bg-red-500 px-4 rounded-full text-white hover:text-red-800 mb-12">Hapus</button>
    </div>
            </div>
        </div>
    </div>
  ...
  <hr class="border-gray-300 my-1 mt-16"/>
    ...
    <div class="flex flex-row text-center">
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Organization</p>
                <p className=''>Panitia YearBook</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Year Start</p>
                <p>Agustus 2020</p>
            ...
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Tittle</p>
                <p>Ketua</p>
            </div>
            <div class="w-1/2">
  ...
  <hr class="border-gray-300 my-1 mt-16"/>
    ...
    <div class="flex flex-row text-center">
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Position</p>
                <p className='mb-7'>-</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Achievemen Date</p>
                <p>-</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Description</p>
            ...
            <div class="w-1/2">
                <p class="font-medium ml-32 text-blue-500">Action</p>
                <div className="absolute top-32 right-1 flex justify-end">
        <button className="text-medium bg-blue-500 px-4 rounded-full text-white hover:text-gray-800 mr-2 mb-12">Edit</button>
        <button className="text-medium bg-red-500 px-4 rounded-full text-white hover:text-red-800 mb-12">Hapus</button>
    </div>
    </div>
  ...
  <hr class="border-gray-300 my-1 mt-16"/>
    ...
    <div class="flex flex-row text-center">
            ...
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Company</p>
                <p>Google</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Address</p>
                <p>Jakarta</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Year Start</p>
            ...
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Type</p>
                <p>Intern</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium text-blue-500">Job Desk</p>
                <p>~Membuat Software</p>
                <p>~Melakukan test software</p>
            </div>
            <div class="w-1/2">
                <p class="font-medium mr-3 text-blue-500">Action</p>
                <div className="absolute bottom-11 right-0 flex justify-end">
        <button className="text-medium bg-blue-500 px-4 rounded-full text-white hover:text-gray-800 mr-2 mb-12">Edit</button>
        <button className="text-medium bg-red-500 px-4 rounded-full text-white hover:text-red-800 mb-12">Hapus</button>
    </div>
            </div>
