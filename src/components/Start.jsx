...
return (
  <section className="section flex flex-col items-center mb-20 justify-center sm:flex-row flex-col" id="Start" style={{ height: "100vh", paddingTop:"200px" }}>
    <div className="flex flex-col items-center justify-between flex-grow max-w-6xl" >
      <motion.div
        className="flex flex-row my-5 sm:ml-[460px] "
        ref={ref1}
      ...
      >
        ...
        <div className="ml-4 font-medium text-lg">
          <h1 className="text-2xl font-semibold text-blue-500">
            Make a cv according to ATS Friedly
          </h1>
          <p className=" py-4 max-w-md">
            This website helps you to create a suitable and friendly CV which has
            become a company standard for recruiting
          </p>
        </div>
      </motion.div>
      <div className="flex flex-row items-center">
        <div style={{borderLeft: "2px solid black", height: "50px"}}></div>
      </div>
        <motion.div 
        className="flex flex-col sm:flex-row-reverse my-5 sm:mr-[425px]"
        ref={ref2}
        ...
        >
          ...
          <div className="mr-4 font-medium text-lg text-right">
        ...
        >
          ...
          <div className="mr-4 font-medium text-right">
